...
/**
 * Helper to get the Escrow contract instance
 */
export const getEscrowContract = (signerOrProvider: ethers.Signer | ethers.Provider) => {
    return new ethers.Contract(RAPHA_ESCROW_ADDRESS, RAPHA_ESCROW_ABI, signerOrProvider);
};
