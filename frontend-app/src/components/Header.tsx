                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <h1 className="text-lg sm:text-xl font-extrabold tracking-tight">
                            <span className="text-gradient hover:opacity-80 transition-opacity">
                                <Link to="/">Rapha Protocol</Link>
                            </span>
                        </h1>
                        <p className="hidden sm:block text-xs text-slate-500 font-medium tracking-wide">
                            Compute-to-Data API <span className="mx-2">•</span>
                            <Link to="/legacy" className="text-slate-600 hover:text-slate-400 underline transition-colors">v1.0 Archive</Link>
                        </p>
                    </div>
                </div>
