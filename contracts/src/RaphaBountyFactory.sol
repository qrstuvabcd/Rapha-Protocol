...
contract RaphaBountyFactory is IRaphaBountyFactory, Ownable, ReentrancyGuard {
     ...
     * @param metadataCommitment Off-chain metadata commitment. Do not put IPFS CIDs or sensitive metadata on-chain.
    ...
    function createPool(
        ...
        require(metadataCommitment != bytes32(0), "Invalid metadata");
