...
/**
 * @title IRaphaMarket
 * @notice Interface for the Rapha Protocol DeSci Compute-to-Data Marketplace
...
interface IRaphaMarket {
    ...
    struct ComputeJob {
        ...
        bytes32 queryCommitment; // Cryptographic hash of the query for integrity
        string encryptedQueryURI;// IPFS URI of the TEE-encrypted query
     ...
     * @param queryCommitment Hash of the query criteria
     * @param encryptedQueryURI IPFS URI of the encrypted query payload
    ...
    function submitJob(
        uint256 bountyAmount,
        bytes32 queryCommitment,
        string calldata encryptedQueryURI,
