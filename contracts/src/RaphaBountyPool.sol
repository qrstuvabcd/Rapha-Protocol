...
contract RaphaBountyPool is IRaphaBountyPool, ReentrancyGuard, Ownable {
    ...
    bytes32 public metadataCommitment;
    ...
    constructor(
        ...
        startup = _startup;
        require(_metadataCommitment != bytes32(0), "Invalid metadata");
     ...
     */
    function submitData(bytes32 _dataCommitment) external nonReentrant {
        require(_hasJoined[msg.sender], "Must join pool first");
        require(_dataCommitment != bytes32(0), "Invalid data commitment");
        ...
        emit DataSubmitted(newId, msg.sender, _dataCommitment);
    }
