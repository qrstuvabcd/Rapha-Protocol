...
contract RaphaMarket is IRaphaMarket, Ownable, ReentrancyGuard {
    ...
    function submitJob(
        ...
        require(queryCommitment != bytes32(0), "Query commitment required");
        require(bytes(encryptedQueryURI).length > 0, "Encrypted query URI required");
        ...
        jobs[jobId] = ComputeJob({
            ...
            encryptedQueryURI: encryptedQueryURI,
        ...
        emit JobSubmitted(jobId, msg.sender, bountyAmount, queryCommitment, encryptedQueryURI);
